// this is my frontend\src\pages\SeeUserData.jsx file
  ...
  return (
    <>
        ...
        <div className={`${userDiv} top-0 left-0 h-screen w-full flex items-center justify-center`}>
            <div className='bg-gray-400 rounded p-4 w-[80%] md:w-[50%] lg:w-[40%] text-zinc-900'>
                <div className='flex items-center justify-between'>
                    <h1 className='text-2xl font-semibold'>
                        User Information
                    </h1>
                    <button className='text-2xl' onClick={() => setuserDiv("hidden")}>
                        <RxCrossCircled />
                    </button>
                </div>
                <div className='mt-2'>
