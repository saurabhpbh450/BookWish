// this is my frontend\src\components\Profile\Sidebar.jsx file 
...
const Sidebar = ({data}) => {
  ...
  return (
    <div className=' p-0 rounded flex flex-col item-center justify-between h-auto lg:h-[100%]'>
        <div className='flex items-center flex-col justify-center'>
          <img 
            src={data.avatar} 
            alt='avatar logo' 
            className='h-[10vh] mt-1 rounded-full object-cover'/>
        ...
        <button 
          className=' w-3/6 lg:w-full mt-4 lg:mt-0 text-white font-semibold flex items-center justify-center py-2 rounded hover:bg-white hover:text-zinc-900 transition-all duration-300' 
          onClick = {() => {
